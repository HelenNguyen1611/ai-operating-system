...
6. A valid response must retain all sections returned by the tool: title/date, Tóm tắt nhanh/Snapshot, Tổng quan/At a glance, Ưu tiên/Priorities, Rủi ro/Risks, Stand-up, plus both team-calendar representations when present.
